...
import { setCurrent, setList, setPageSize, init, setPagination, setPaginationProps } from '@/store/customer/former/action'
...
export default class Home extends React.Component<P, any> {
    ...
    getData = async () => {
        ...
        const { data, total } = await window.$api.customerFormerList({ current: current, pageSize: pageSize })
