...
const getPrice = (multiple) => {
  return Number(
    ((price * multiple) / (price * multiple > 1000 ? 100 : 10)).toFixed(0) +
      (price * multiple > 1000 ? '00' : '0')
  )
}
...
export const scaleArr: Node[] = setArr([
  '小于20人',
  '20-50人',
  '50-100人',
  '100-500人',
...
export const typeArr: Node[] = setArr([
  '合资',
  '独资',
  '国有',
  '私营',
...
export const indArr: Node[] = setArr([
  '住宿和餐饮',
  '金融',
  '房地产',
  '互联网',
